        ...
        <div>
            <section className="dog-food-section">
                ...
                <div className="free-shipping">
                    <p>
                        <span className="shipping-icon">🚚</span> Free shipping on orders over $40!
                    </p>
                </div>
            </section>
            <div className="trending-section">
                ...
                <div className="trending-items">
                    <div className="trending-item">
                        <a href="#"><img src="https://petmania.vamtam.com/wp-content/uploads/2022/07/iStock-1271793136.jpg" alt="Outdoor Toys" className="trending-image" /></a>
                        <p className="trending-shop">Shop</p>
                        <h3 className="trending-name">Outdoor Toys</h3>
                    </div>
                    <div className="trending-item">
                        <a href="#"><img src="https://petmania.vamtam.com/wp-content/uploads/2022/07/iStock-1398781665.jpg" alt="Outdoor Toys" className="trending-image" /></a>
                        <p className="trending-shop">Shop</p>
                        <h3 className="trending-name">Vital Care</h3>
                    </div>
                    <div className="trending-item">
                        <a href="#"> <img src="https://petmania.vamtam.com/wp-content/uploads/2022/07/iStock-1140125261.jpg" alt="Fresh & Frozen" className="trending-image" /> </a>
                        <p className="trending-shop">Shop</p>
                        <h3 className="trending-name">Fresh & Frozen</h3>
                    </div>
                </div>
                <Categories />
                <ItemListContainer limit={4} /> {/* LIMITE LOS PRODUCTOS  */}
            </div>
